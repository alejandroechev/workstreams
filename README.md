...
- **App settings** — Status-bar gear opens a Settings modal. Three global font sizes (code editor, markdown body, terminal cell) plus terminal scroll speed; persisted in the SQLite settings table.
